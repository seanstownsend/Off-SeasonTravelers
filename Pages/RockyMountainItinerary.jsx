...
const RockyMountainItinerary = () => {
  const [currentItinerary, setCurrentItinerary] = useState(null);
  
  useEffect(() => {
    const parkItinerary = itineraryData['rocky-mountain'];
    if (parkItinerary) {
      setCurrentItinerary(parkItinerary);
    } else {
      setCurrentItinerary({
        title: 'Rocky Mountain National Park Itinerary',
  ...
  return (
    <div className="rocky-mountain-itinerary">
      <style jsx>{`
      ...
      <div className="itinerary-footer">
        <div className="cta-section">
          <h3>Ready to Plan Your Rocky Mountain Adventure?</h3>
          <p>Experience towering peaks and alpine wilderness beauty!</p>

...
export default function WrangellStEliasItinerary() {
  const [currentItinerary, setCurrentItinerary] = useState(null);
  
  useEffect(() => {
    const parkItinerary = itineraryData['wrangell-st-elias'];
    if (parkItinerary) {
      setCurrentItinerary(parkItinerary);
    } else {
      setCurrentItinerary({
        title: 'Wrangell-St. Elias National Park Itinerary',
        subtitle: 'Off-season wilderness guide',
  ...
  return (
    <div className="wrangell-itinerary">
      <style jsx>{`
        .wrangell-itinerary {
      ...
      <div className="itinerary-footer">
        <div className="cta-section">
          <h3>Ready to Plan Your Wilderness Adventure?</h3>
          <p>Get expert guidance for America's largest national park!</p>

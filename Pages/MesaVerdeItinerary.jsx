...
const MesaVerdeItinerary = () => {
  const [currentItinerary, setCurrentItinerary] = useState(null);
  
  useEffect(() => {
    const parkItinerary = itineraryData['mesa-verde'];
    if (parkItinerary) {
      setCurrentItinerary(parkItinerary);
    } else {
      setCurrentItinerary({
        title: 'Mesa Verde National Park Itinerary',
        subtitle: 'Off-season archaeological adventure guide',
  ...
  return (
    <div className="mesa-verde-itinerary">
      <style jsx>{`
      ...
      <div className="itinerary-footer">
        <div className="cta-section">
          <h3>Ready to Plan Your Archaeological Adventure?</h3>
          <p>Discover ancient cliff dwellings and Ancestral Puebloan culture!</p>
...
export default MesaVerdeItinerary;
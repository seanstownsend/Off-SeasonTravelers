...
const ShenandoahItinerary = () => {
  const [currentItinerary, setCurrentItinerary] = useState(null);
  
  useEffect(() => {
    const parkItinerary = itineraryData['shenandoah'];
    if (parkItinerary) {
      setCurrentItinerary(parkItinerary);
    } else {
      setCurrentItinerary({
        title: 'Shenandoah National Park Itinerary',
        subtitle: 'Off-season scenic mountain guide',
  ...
  return (
    <div className="shenandoah-itinerary">
      <style jsx>{`
      ...
      <div className="itinerary-footer">
        <div className="cta-section">
          <h3>Ready to Plan Your Shenandoah Adventure?</h3>
          <p>Experience scenic mountain drives and peaceful wilderness!</p>
...
export default ShenandoahItinerary;